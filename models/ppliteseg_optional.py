...
if __name__ == '__main__':
    ...
    model = PPLiteSeg(num_classes = 1, arm_out_chs = [128], seg_head_inter_chs = [64])
    data_in = torch.randn((16, 3, 1024, 1024))
    data_out = model(data_in)
    print(data_out.shape)
    # print(data_out[0].shape, data_out[1].shape, data_out[2].shape, len(data_out))
    summary(model, input_size=(16, 3, 1024, 1024))